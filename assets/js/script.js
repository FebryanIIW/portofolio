...
// Dirubah 
const pengirim = "Febryan Al";
const nomorWa = "6281216393961" // awalan nomor 0 harus di awalin 62
const textWa = "hehehe.."
const pesan = ` love u ❤️`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Coba Ketik namamuu disinii',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`apaa ajaa...tuliss jangan kosong`)
      }
      return { login }
    }
  }).then((result) => {
    ...
    let txt = `Hallooo:) ${result.value.login}, ${namaAwal.toUpperCase()}, ${pesan}`;
